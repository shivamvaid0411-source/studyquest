...
Want to run this on your machine or customize it for your own university/branch?

```bash
# 1. Clone the repo
git clone [https://github.com/your-username/studyquest.git](https://github.com/your-username/studyquest.git)
